...
use ZhorX\StatusCode\Exceptions\UndefinedError;
use ZhorX\StatusCode\Http;
...
class HttpTest extends TestCase
{
    ...
    public function testUndefinedErrorCodeThrowsException()
    {
        $this->expectException(UndefinedError::class);
        Http::INVALID_STATUS_CODE();
    }
}
